...
ConeheadZombie::ConeheadZombie():Zombie("ConeheadZombie","://PVZ_Images/Zombies/ConeheadZombie/ConeheadZombie_body0.gif")
{
    attack=100*33/1000;
...
void ConeheadZombie::advance(int phase)
{
    ...
    else
    {
        ...
        if (!items.isEmpty())
        {
            ...
            {
                state = 1;
                setBody("://PVZ_Images/Zombies/ConeheadZombie/ConeheadZombie_body1.gif");
            }
        ...
        else//无碰撞
        {
            ...
            {
                state=0;
                setBody("://PVZ_Images/Zombies/ConeheadZombie/ConeheadZombie_body0.gif");
            }
            setX(x() - speed);//前进
            return;
        }
